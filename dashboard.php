...
$countAppt = "SELECT COUNT(*) AS total FROM appointments";
$apptQuery = $connect->query($countAppt);
$row = $apptQuery->fetch_assoc();
$countAppt = $row['total'];
...
<div class="container-fluid">
             ...
             <marquee direction="left" behavior="alternate" scrollamount=1 >
                  <h3 style="color:red"><b>MCA Final Year Project by Md Arish Tufail</b></h3>
               </marquee>
 ...
 <div class="media widget-ten">
    ...
    <div class="card" style="background-color:#007bff;">
        <div class="media widget-ten">
            <div class="media-left meida media-middle">
                <span><i class="ti-agenda f-s-60"></i></span>
            </div>
            <div class="media-body media-text-right">
                <h2 class="color-white"><?php echo $countAppt; ?></h2>
                <a href="appointment.php"><p class="m-b-0">Total Appointments</p></a>
            </div>
        </div>
    </div>
</div>
